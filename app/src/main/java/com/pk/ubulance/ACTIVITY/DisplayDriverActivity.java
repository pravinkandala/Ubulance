...
public class DisplayDriverActivity extends AppCompatActivity {
    ...
    TextView _driver_name, _driver_phone, _driver_rating, _status, _eta, _vehicle_make, _vehicle_model, _vehicle_plate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _driver_phone.setVisibility(View.GONE);
        ...
        try {
            uberAPI.callUbulance(this, start_latitude, start_longitude, end_latitude, end_longitude, new ServerCallBack() {
                ...
                public void onSuccess(Object result) throws JSONException {
                    ...
                    _driver_phone.setOnClickListener(new View.OnClickListener() {

                        @Override
                        public void onClick(View view) {

                            try {
                                callIntent.setData(Uri.parse("tel:+" + driver.getString("phone_number").trim()));
